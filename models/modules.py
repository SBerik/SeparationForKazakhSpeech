...
class Encoder(torch.nn.Module):
    ...
    def __init__(self, kernel_size=2, out_channels=64, bias=True):
        super(Encoder, self).__init__()
        self.conv1d = torch.nn.Conv1d(in_channels=1, out_channels=out_channels,
                                kernel_size=kernel_size, stride=kernel_size//2, groups=1, bias=bias)
